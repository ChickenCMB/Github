  ...
  <div id="loading-screen" class="minecraft-3d-loading">
    <div class="loading-container">
      <div class="minecraft-block">
        <div class="block-face front" style="background-image: url('assets/loading/1.png')"></div>
        <div class="block-face back" style="background-image: url('assets/loading/2.png')"></div>
        <div class="block-face right" style="background-image: url('assets/loading/3.png')"></div>
        <div class="block-face left" style="background-image: url('assets/loading/4.png')"></div>
        <div class="block-face top" style="background-image: url('assets/loading/5.png')"></div>
        <div class="block-face bottom" style="background-image: url('assets/loading/6.png')"></div>
      </div>
